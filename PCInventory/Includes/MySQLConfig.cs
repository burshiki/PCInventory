...
namespace PCInventory
{
    ...
    {
        private MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=pc_inventory;sslMode=none");
        ...
        public void Load_DVG(string sql, DataGridView dtg)
        {
            try
            {
                con.Open();
        ...
        public void fill_CB(string sql, ComboBox cbo)
        {
            try
            {
                con.Open();
